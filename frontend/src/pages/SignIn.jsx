...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-primary-dark via-primary to-primary-light items-center justify-center p-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="absolute rounded-full bg-white"
              style={{ width: `${80 + i * 40}px`, height: `${80 + i * 40}px`, top: `${10 + i * 12}%`, left: `${5 + i * 8}%`, opacity: 0.3 }} />
          ))}
        </div>
        <div className="relative text-center text-white">
          ...
          <img src="/icons.svg" alt="" className="w-72 mx-auto mb-6 opacity-90" onError={(e) => e.target.style.display='none'} />
          <p className="text-white/80 text-lg">Your AI-powered study companion</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <h1 className="font-serif text-3xl font-bold text-gray-800 mb-1">Sign In</h1>
          <p className="text-gray-500 text-sm mb-7">Welcome back to your study hub</p>
          ...
          <div className="mb-5">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60"
            >
